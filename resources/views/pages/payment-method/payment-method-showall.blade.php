    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">PaymentMethods</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
                                ...
                                @foreach ($payment_methods as $method)
                                    <tr>
                                        ...
                                        <td><button class="modal-effect btn btn-secondary-gradient btn-pill btn-edit" title="Edit"
                                                ...
                                                data-bs-target="#modal_" data-id="{{ $method['id'] }}"
                                                data-name="{{ $method['payment_method_name'] }}"
                                                data-description="{{ $method['description'] }}"><i
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered text-center" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Payment Methods</h6><button aria-label="Close" class="btn-close"
                        data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body text-start">
                    <form action="{{ route('payment-method.addProcess') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">Please Enter the Payment Method.</div>
                        </div>
                        <div class="form-group">
