                                ...
                                @foreach ($classes as $class)
                                    <tr>
                                        ...
                                        <td><button class="modal-effect btn btn-secondary-gradient btn-pill btn-edit" title="Edit"
                                                ...
                                                data-bs-target="#modal_" data-id="{{ $class['id'] }}"
                                                data-name="{{ $class['name'] }}"
                                                data-description="{{ $class['description'] }}"><i
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered text-center" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Class</h6><button aria-label="Close" class="btn-close"
                        data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body text-start">
                    <form action="{{ route('class.addProcess') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
